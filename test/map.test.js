...
test('map should return all names', (expect) => {
    //Arrange
...
test('map should return all objects with an added isHungry property equal to true', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = [
...
test('map should return a shouting array', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = [
        { name: 'SCOOTER', type: 'puppy' },
...
test('map should return a proper array of strings', (expect) => {
    //Arrange
    // Set up your arguments and expectations
...
test('map should return a proper array of arrays', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = [
        [['name', 'scooter'], ['type', 'puppy']], 
