...
test('object should return an object with screaming keys', (expect) => {
    //Arrange
...
test('object should make a string from the keys', (expect) => {
    //Arrange
    // Set up your arguments and expectations    
    //Act 
    // Call the function you're testing and set the result to a const
...
test('object should return tuples', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = [
        ['name', 'scooter'],
