...
test('for each should make an array of names', (expect) => {
    //Arrange
...
test('for each should make a reverse array of type', (expect) => {
    //Arrange
    // Set up your arguments and expectations
...
test('for each should make a spanish array of pet objects', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = [
        {
